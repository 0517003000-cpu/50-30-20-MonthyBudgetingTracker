...
if(remaining <= 500000) return "Tight Budget"
return "Under Budget"
}
...
• Start small and stay consistent.`
  ...
  // ✅ FIXED: now based on AVAILABLE INCOME (saveBudget)
  let emergency = Math.floor(saveBudget * 0.5)
  let invest = Math.floor(saveBudget * 0.3)
  let goals = Math.floor(saveBudget * 0.2)

  savingsText = `• Here’s a recommended way to manage your savings budget:<br><br>
